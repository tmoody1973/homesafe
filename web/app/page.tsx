        ...
        <div className="hs-wrap">
          ...
          <div className="hs-steps">
            <div>
              ...
              <p>
                Dated, private notes — with photos described by you, never analysed by the
                AI, and location data stripped before an image leaves your phone.
              </p>
            </div>
            <div>
              ...
              <p>
                ...
                permit. Patterns are what inspectors act on — HomeSafe makes them legible.
              </p>
            </div>
            <div>
              ...
              <p>
                ...
                sanitary code — and shows exactly what it read. Uncited claims are removed,
                visibly.
              </p>
            </div>
          </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  tasks. Six kinds of memory — records, journal, vectors, agent diary,
                  task state, audit log — in one cluster.
                </td>
              </tr>
              <tr>
        ...
        <section>
          <div className="hs-wrap">
            <p className="hs-colophon">
              HomeSafe — built for the CockroachDB × AWS hackathon, 2026. Public records
